...
Updated TinkersLevellingAddon-1.20.1-1.4.2.jar
Added infernalmobs-1.20.1.6.jar
Added spawnbalanceutility-1.20-46.13.6.jar
Added MushroomQuest-1.20.1-v4.1.2.jar
Added alexsmobsinteraction-5.0-all.jar
Added MyServerIsCompatible-1.20-1.0.jar
Added ServerTabInfo-1.20-1.3.8.jar
Removed Champions Mod
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-

3/6/25:
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
Added item-filters-forge-2001.1.0-build.59.jar
Added accessories_cclayer-7.4.0-beta.18+1.20.1.jar (Replaced Curios)
Updated the Immersive Engineering Questline
Updated All the Image issues with all questlines in FTBQuests
Updated Starter Kits so that first join only has the FTB Quest Book
Removed Celestial Relics Items at first join
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
